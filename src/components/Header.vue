  ...
  <div class="header">
    <div class="header-content">
      ...
      <nav v-if="windowWidth > 750">
        <div id="interests" class="active-link">Interests</div>
        <div id="goals" class="passive-link">Goals</div>
        <div id="feed" class="passive-link">Feed</div>
      </nav>
      <nav v-else>
        <div id="interests" class="active-link" title="Interests">
          <i class="fas fa-heart"></i>
        </div>
        <div id="goals" class="passive-link" title="Goals">
